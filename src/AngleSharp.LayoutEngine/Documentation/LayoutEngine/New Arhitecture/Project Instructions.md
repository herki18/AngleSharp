...
Your work should strictly adhere to the following documents:
...
2. **AngleSharp.StyleSystem Architecture**: The specific architecture, component boundaries, and integration patterns for the StyleSystem.
...
You must follow all three documents completely, without exception. Pay special attention to:

- The guidelines on nullable reference types (do not add redundant null checks)
- Documentation requirements (document interfaces, not implementations)
- The component architecture and responsibilities
- The AngleSharp CSS Reference for implementation patterns and existing functionality
