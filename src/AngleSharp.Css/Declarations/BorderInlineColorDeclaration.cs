namespace AngleSharp.Css.Declarations
{
    ...
    static class BorderInlineColorDeclaration
    {
        public static String Name = PropertyNames.BorderInlineColor;
        public static String[] Shorthands = new[]
        {
            PropertyNames.BorderInline,
        };
        public static IValueConverter Converter = new BorderInlineColorAggregator();
        ...
        sealed class BorderInlineColorAggregator : IValueAggregator, IValueConverter
        {
            private static readonly IValueConverter converter = CurrentColorConverter.FlowRelative();
