namespace AngleSharp.Css.Declarations
{
    ...
    /// <summary>
    /// Represents the border-block-end-width CSS property.
    /// </summary>
    /// <remarks>
    /// The border-block-end-width CSS property defines the width of the logical block-end border of an element,
