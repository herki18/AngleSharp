namespace AngleSharp.Css.Declarations
{
    ...
    /// <summary>
    /// Represents the border-block-end-style CSS property.
    /// </summary>
    /// <remarks>
    /// The border-block-end-style CSS property defines the style of the logical block-end border of an element,
