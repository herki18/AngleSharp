namespace AngleSharp.Css.Declarations
{
    ...
    /// <summary>
    /// Represents the border-block-end-color CSS property.
    /// </summary>
    /// <remarks>
    /// The border-block-end-color CSS property defines the color of the logical block-end border of an element,
