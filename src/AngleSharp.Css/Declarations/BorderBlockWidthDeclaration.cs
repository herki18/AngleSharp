namespace AngleSharp.Css.Declarations
{
    ...
    static class BorderBlockWidthDeclaration
    {
        public static String Name = PropertyNames.BorderBlockWidth;
        public static String[] Shorthands = new[]
        {
            PropertyNames.BorderBlock,
        };
        public static IValueConverter Converter = new BorderBlockWidthAggregator();
        ...
        sealed class BorderBlockWidthAggregator : IValueAggregator, IValueConverter
        {
            private static readonly IValueConverter converter = LineWidthConverter.FlowRelative();
