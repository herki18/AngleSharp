...
- Use file-scoped namespaces in the C# code.
...
- The main implementation should be as complete as possible, even if it calls stubs or contains broken code due to missing pieces.
...
- Do not worry about the correctness or completeness of the stubs—just make sure the main class and its methods are as close to the C++ logic as possible.
...
- Use `using` directives at the top of the file as needed.
...
```csharp
// ===== STUBS =====
// All stubs here, also using file-scoped namespace and C# naming conventions
namespace MyNamespace;
