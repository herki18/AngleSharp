...
using Css;
using Dom;
using StyleEngine = StyleSystem.StyleEngine;

[TestFixture]
public class StyleEngineIntegrationTests
{
    ...
    public async Task ComputeElementStyle_BasicStyling_ComputesCorrectly()
    {
        ...
        var engine = new StyleEngine(_device, _context, document);
    ...
    public async Task ComputeElementStyle_MediaQueriesFilterRules()
    {
        ...
        var engine = new StyleEngine(device, _context, document);
        ...
        engine = new StyleEngine(device, _context, document);
