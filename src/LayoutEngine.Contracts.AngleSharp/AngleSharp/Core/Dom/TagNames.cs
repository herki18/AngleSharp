...
public static class TagNames
{
    ...
    public static readonly HashSet<StringOrMemory> AllForeignExceptions = new (OrdinalStringOrMemoryComparer.Instance)
    {
    ...
    public static readonly HashSet<StringOrMemory> AllBeforeHead = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Html, Body, Br, Head
    };

    public static readonly HashSet<StringOrMemory> AllNoShadowRoot = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Button, Details, Input, Marquee, Meter, Progress, Select, Textarea, Keygen
    };

    public static readonly HashSet<StringOrMemory> AllHead = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Style, Link, Meta, Title, NoFrames, Template, Base, BaseFont, Bgsound
    };

    public static readonly HashSet<StringOrMemory> AllHeadNoTemplate = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Link, Meta, Script, Style, Title, Base, BaseFont, Bgsound, NoFrames
    };

    public static readonly HashSet<StringOrMemory> AllHeadBase = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Link, Base, BaseFont, Bgsound
    };

    public static readonly HashSet<StringOrMemory> AllBodyBreakrow = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Br, Area, Embed, Keygen, Wbr
    };

    public static readonly HashSet<StringOrMemory> AllBodyClosed = new (OrdinalStringOrMemoryComparer.Instance)
    {
        MenuItem, Param, Source, Track
    };

    public static readonly HashSet<StringOrMemory> AllNoScript = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Style, Link, BaseFont, Meta, NoFrames, Bgsound
    };

    public static readonly HashSet<StringOrMemory> AllHeadings = new (OrdinalStringOrMemoryComparer.Instance)
    {
        H3, H2, H4, H1, H6, H5
    };

    public static readonly HashSet<StringOrMemory> AllBlocks = new (OrdinalStringOrMemoryComparer.Instance)
    {
    ...
    public static readonly HashSet<StringOrMemory> AllBody = new (OrdinalStringOrMemoryComparer.Instance)
    {
    ...
    public static readonly HashSet<StringOrMemory> AllBodyObsolete = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Applet, Marquee, Object
    };

    public static readonly HashSet<StringOrMemory> AllInput = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Input, Keygen, Textarea
    };

    public static readonly HashSet<StringOrMemory> AllBasicBlocks = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Address, Div, P
    };

    public static readonly HashSet<StringOrMemory> AllSemanticFormatting = new (OrdinalStringOrMemoryComparer.Instance)
    {
        B, Strong, Code, Em, U, I
    };

    public static readonly HashSet<StringOrMemory> AllClassicFormatting = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Font, S, Small, Strike, Big, Tt
    };

    public static readonly HashSet<StringOrMemory> AllFormatting = new (OrdinalStringOrMemoryComparer.Instance)
    {
        B, Strong, Code, Em, U, I, NoBr, Font, S, Small, Strike, Big, Tt
    };

    public static readonly HashSet<StringOrMemory> AllNested = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Td, Tfoot, Th, Thead, Tr, Caption, Col, Colgroup, Frame, Head
    };

    public static readonly HashSet<StringOrMemory> AllCaptionEnd = new(OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Col, Tfoot, Td, Thead, Caption, Th, Colgroup, Tr
    };

    public static readonly HashSet<StringOrMemory> AllCaptionStart = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Col, Tfoot, Td, Thead, Tr, Body, Th, Colgroup, Html
    };

    public static readonly HashSet<StringOrMemory> AllTable = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Col, Tfoot, Td, Thead, Tr
    };

    public static readonly HashSet<StringOrMemory> AllTableRoot = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Caption, Colgroup, Tbody, Tfoot, Thead
    };

    public static readonly HashSet<StringOrMemory> AllTableGeneral = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Caption, Colgroup, Col, Tbody, Tfoot, Thead
    };

    public static readonly HashSet<StringOrMemory> AllTableSections = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Tfoot, Thead
    };

    public static readonly HashSet<StringOrMemory> AllTableMajor = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Tfoot, Thead, Table, Tr
    };

    public static readonly HashSet<StringOrMemory> AllTableSpecial = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Td, Th,  Body, Caption, Col, Colgroup, Html
    };

    public static readonly HashSet<StringOrMemory> AllTableCore = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tr, Table, Tbody, Tfoot, Thead
    };

    public static readonly HashSet<StringOrMemory> AllTableInner = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tbody, Tr, Thead, Th, Tfoot, Td
    };

    public static readonly HashSet<StringOrMemory> AllTableSelects = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tr, Table, Tbody, Tfoot, Thead, Td, Th, Caption
    };

    public static readonly HashSet<StringOrMemory> AllTableCells = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Td, Th
    };

    public static readonly HashSet<StringOrMemory> AllTableCellsRows = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Tr, Td, Th
    };

    public static readonly HashSet<StringOrMemory> AllTableHead = new (OrdinalStringOrMemoryComparer.Instance)
    {
        Script, Style, Template
    };

    public static readonly HashSet<StringOrMemory> DisallowedCustomElementNames = new (OrdinalStringOrMemoryComparer.Instance)
    {
        "annotation-xml",
        "color-profile",
        "font-face",
