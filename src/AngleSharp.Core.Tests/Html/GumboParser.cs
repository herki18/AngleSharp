namespace AngleSharp.Core.Tests.Html
{
    ...
    public class GumboParserTests
    {
        ...
        public void GumboDoubleBody()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)txt.NodeType);
        ...
        public void GumboMisnestedHeading()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)h3.NodeType);
        ...
        public void GumboLinkifiedHeading()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)li.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)anchor.NodeType);
            Assert.AreEqual("a", anchor.GetTagName());
            Assert.AreEqual(1, anchor.ChildNodes.Length);

            var div = li.ChildNodes[1];
            Assert.AreEqual(NodeType.Element, (NodeType)div.NodeType);
        ...
        public void GumboFormattingTagsInHeading()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)bimpl.NodeType);
  ...
  <li>Second
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)li1.NodeType);
            Assert.AreEqual("li", li1.GetTagName());
            Assert.AreEqual(1, li1.ChildNodes.Length);

            var li2 = ul.ChildNodes[2];
            Assert.AreEqual(NodeType.Element, (NodeType)li2.NodeType);
        ...
        public void GumboAdoptionAgency1()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)i.NodeType);
        ...
        public void GumboAdoptionAgency2()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)badopt.NodeType);
        ...
        public void GumboNoahsArkClause()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)p1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)red1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)p2.NodeType);
            Assert.AreEqual("p", p2.GetTagName());
            Assert.AreEqual(1, p2.ChildNodes.Length);

            var red2 = p2.ChildNodes[0] as Element;
            Assert.AreEqual(NodeType.Element, (NodeType)red2.NodeType);
        ...
        public void GumboRawtextInBody()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)noembed.NodeType);
        ...
        public void GumboIsIndex()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)form.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)hr1.NodeType);
            Assert.AreEqual("hr", hr1.GetTagName());
            Assert.AreEqual(0, hr1.ChildNodes.Length);

            var label = form.ChildNodes[1];
            Assert.AreEqual(NodeType.Element, (NodeType)label.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)input.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)hr2.NodeType);
        ...
        public void GumboComplicatedSelect()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)optgroup.NodeType);
        ...
        public void GumboOneChar()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)root.NodeType);
            Assert.AreEqual(2, root.ChildNodes.Length);
        ...
        public void GumboUnexpectedEndBreak()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)br.NodeType);
...
<body><div class=bar>Test</div></body></html>").ToHtmlDocument();
  ...
  <body>Foo</body>").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)link1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)link2.NodeType);
        ...
        public void GumboInvalidDoctype()
        {
            ...
            Assert.AreEqual(QuirksMode.On, document.QuirksMode);
            Assert.AreEqual(1, document.ChildNodes.Length);
...
-->").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)document.NodeType);
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)comment.NodeType);
        ...
        public void GumboCommentInText()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)start.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)end.NodeType);
        ...
        public void GumboUnknownTag1()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)foo.NodeType);
        ...
        public void GumboUnknownTag2()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)sarcasm.NodeType);
        ...
        public void GumboInvalidEndTag()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)a.NodeType);
            Assert.AreEqual("a", a.GetTagName());
            Assert.AreEqual(1, a.ChildNodes.Length);

            var img = a.ChildNodes[0];
            Assert.AreEqual(NodeType.Element, (NodeType)img.NodeType);
  ...
  <iframe></iframe>
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)iframe.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)table_text.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)tr_text.NodeType);
            Assert.AreEqual(tr, tr_text.ParentElement);
            Assert.AreEqual("\n    ", tr_text.TextContent);

            var th = tr.ChildNodes[1];
            Assert.AreEqual(NodeType.Element, (NodeType)th.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)th_text.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)td_text.NodeType);
        ...
        public void GumboStartParagraphInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)paragraph.NodeType);
  ...
  <tr><td>Row3
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)td1_text.NodeType);
            Assert.AreEqual("One\n    ", td1_text.TextContent);

            var td2_text = td2.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)td2_text.NodeType);
            Assert.AreEqual("Two\n  ", td2_text.TextContent);

            var tr3 = tbody.ChildNodes[2];
            Assert.AreEqual(NodeType.Element, (NodeType)tr3.NodeType);
            Assert.AreEqual("tr", tr3.GetTagName());
            Assert.AreEqual(1, tr3.ChildNodes.Length);

            var body_text = body.ChildNodes[1];
            Assert.AreEqual(NodeType.Text, (NodeType)body_text.NodeType);
        ...
        public void GumboMisnestedTable2()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)cell1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)th1.NodeType);
