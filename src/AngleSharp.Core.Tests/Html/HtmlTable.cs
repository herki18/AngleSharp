namespace AngleSharp.Core.Tests.Html
{
    ...
    public class HtmlTableTests
    {
        ...
        public void TableWithSingleTh()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody0tr0th0.NodeType);
        }
        ...
        public void TableWithRowAndCaption()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0caption1.NodeType);
        }
        ...
        public void TableWithTdButtonAndTd()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody0tr0td0button0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody0tr0td1.NodeType);
        }
        ...
        public void TableWithRowCellAndSvgDescTd()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody0tr0td0svg0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody0tr0td0svg0desc0.NodeType);
