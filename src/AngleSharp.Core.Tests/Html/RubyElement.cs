namespace AngleSharp.Core.Tests.Html
{
    ...
    public class RubyElementTests
    {
        ...
        public void RubyElementImpliedEndForRbWithRtc()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc2.NodeType);
        }
        ...
        public void RubyElementImpliedEndForRbWithRp()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rp2.NodeType);
        }
        ...
        public void RubyElementNoImpliedEndForRbWithSpan()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rb1span1.NodeType);
        }
        ...
        public void RubyElementNoImpliedEndForRtWithSpan()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rt1span1.NodeType);
        }
        ...
        public void RubyElementNoImpliedEndForRtcWithRt()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc1rt2.NodeType);

            var dochtml0body1ruby0rtc1rt2Text0 = dochtml0body1ruby0rtc1rt2.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1ruby0rtc1rt2Text0.NodeType);
        ...
        public void RubyElementImpliedEndForRtcWithRp()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc1rp1.NodeType);
        }
        ...
        public void RubyElementNoImpliedEndForRtcWithSpan()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc1span1.NodeType);
        }
        ...
        public void RubyElementNoImpliedEndForRpWithSpan()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rp1span1.NodeType);
        }
        ...
        public void RubyElementImpliedEndWithRuby()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc0ruby0.NodeType);

            var dochtml0body1ruby0rtc0ruby0Text0 = dochtml0body1ruby0rtc0ruby0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1ruby0rtc0ruby0Text0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc0ruby0rb1.NodeType);

            var dochtml0body1ruby0rtc0ruby0rb1Text0 = dochtml0body1ruby0rtc0ruby0rb1.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1ruby0rtc0ruby0rb1Text0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1ruby0rtc0ruby0rt2.NodeType);
        }
    }
}