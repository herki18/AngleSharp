namespace AngleSharp.Core.Tests.Html
{
    ...
    public class HtmlFragmentTests
    {
        ...
        public void FragmentBodyContextDoubleBodyAndSpanElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docspan0.NodeType);
        }
        ...
        public void FragmentHtmlContextBodyAndSpanElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docbody1span0.NodeType);
        }
        ...
        public void FragmentHtmlContextFramesetAndSpanElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docframeset1.NodeType);
        }
        ...
        public void FragmentSelectContextClosingSelectAndOptionElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docoption0.NodeType);
        }
        ...
        public void FragmentTdContextTableAndDoubleTdElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctable0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctable0tbody0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctable0tbody0tr0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctable0tbody0tr0td0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctable0tbody0tr0td1.NodeType);
        ...
        public void FragmentTdContextTfootAndAnchorElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doca0.NodeType);
        }
        ...
        public void FragmentTrContextTdAndFinishedTableAndTdElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctd0table0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctd1.NodeType);
        }
        ...
        public void FragmentTbodyContextTdAndTableAndTbodyAndMisplacedAnchorAndTrElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctr0td0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctr0td0a0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctr0td0table1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctr0td0table1tbody0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctr0td0table1tbody0tr0.NodeType);
        ...
        public void FragmentHtmlContextWithText()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)docbody1Text0.NodeType);
        ...
        public void FragmentHeadContextWithTextInTitle()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctitle0.NodeType);

            var doctitle0Text0 = doctitle0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)doctitle0Text0.NodeType);
