namespace AngleSharp.Core.Tests.Html
{
    ...
    public class HtmlStyleTests
    {
        ...
        public void StyleWithNestedCommentAndOtherStyles()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml1head0Comment1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1head0style2.NodeType);

            var dochtml1head0style2Text0 = dochtml1head0style2.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1head0style2Text0.NodeType);
