namespace AngleSharp.Core.Tests.Html
{
    ...
    public class RawtextTests
    {
        ...
        public void StartOfCommentInStyleElement()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0head0Text1.NodeType);
        ...
        public void XmpInParagraphElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1xmp1.NodeType);
        }
        ...
        public void NoScriptElementWithComment()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0head0noscript0Comment0.NodeType);
