namespace AngleSharp.Core.Tests.Html
{
    ...
    public class CDataTests
    {
        ...
        public void CDataInMathElement()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1math0Text0.NodeType);
        ...
        public void CDataInDivElement()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0body1div0Comment0.NodeType);
        ...
        public void CDataInDivLocatedInForeignObjectWhichIsPlacedInSvgElement()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1svg0foreignObject0div0.NodeType);

            var dochtml0body1svg0foreignObject0div0Comment0 = dochtml0body1svg0foreignObject0div0.ChildNodes[0];
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0body1svg0foreignObject0div0Comment0.NodeType);
        ...
        public void CDataWithSvgTagInSvgElementFollowedByComment()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0body1svg0Comment1.NodeType);
