namespace AngleSharp.Core.Tests.Html
{
 ...
 <frameset></frameset>").ToHtmlDocument();
        ...
        public void PlaintextWithFillerText()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1plaintext0.NodeType);

            var dochtml0body1plaintext0Text0 = dochtml0body1plaintext0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1plaintext0Text0.NodeType);
        ...
        public void NullCharacterInCDataWithFillerInSvg()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1svg0Text0.NodeType);
        ...
        public void NullCharacterInComment()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0body1child.NodeType);
        }
        ...
        public void NullAndOtherCharactersInComment()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0body1Comment.NodeType);
        }
        ...
        public void NullCharactersInForeignObjectInSvg()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1svg0foreignObject0.NodeType);

            var dochtml0body1svg0foreignObject0Text0 = dochtml0body1svg0foreignObject0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1svg0foreignObject0Text0.NodeType);
...
A</pre>").ToHtmlDocument();
        ...
        public void NullCharacterInMathTextInMathTag()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1table0tbody0tr0td0math0mtext0Text0.NodeType);
        ...
        public void NullCharacterAfterLetterInMathNumeric()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1math0mn0Text0.NodeType);
        ...
        public void NoFramesWithCommentInsideThatContainsAnotherNoFramesPair()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1head0noframes0.NodeType);

            var dochtml1head0noframes0Text0 = dochtml1head0noframes0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1head0noframes0Text0.NodeType);
