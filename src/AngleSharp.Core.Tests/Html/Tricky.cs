...
Also not bold.").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlhead.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbody.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyb.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyp.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodypb.NodeType);

            var text1 = dochtmlbodypb.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)text1.NodeType);
            Assert.AreEqual("Bold ", text1.TextContent);

            var text2 = dochtmlbodyp.ChildNodes[1];
            Assert.AreEqual(NodeType.Text, (NodeType)text2.NodeType);
            Assert.AreEqual(" Not bold", text2.TextContent);

            var text3 = dochtmlbody.ChildNodes[2];
            Assert.AreEqual(NodeType.Text, (NodeType)text3.NodeType);
...
<b>Bold <i>Bold and italic</b> Only Italic </i> Plain").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfont1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfonti1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyi1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyip.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyipfont.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfont2.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfonti2.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodypfont.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)text8.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodybi.NodeType);

            var text9 = dochtmlbodybi.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)text9.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyi3.NodeType);

            var text10 = dochtmlbodyi3.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)text10.NodeType);
            Assert.AreEqual(@" Only Italic ", text10.TextContent);

            var text11 = dochtmlbody.ChildNodes[9];
            Assert.AreEqual(NodeType.Text, (NodeType)text11.NodeType);
...
<b><p><i>Bold and Italic</b> Italic</p>").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyp1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfont.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfontp.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyp2.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodypbi.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodypi.NodeType);
...
<dd>Goo?
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydl.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydldt.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydldtb.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydldd.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydlddb.NodeType);
        ...
        public void HelloWorldWithSomeDivs()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodylabel.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodylabela.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodylabeldiv.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodylabeldiva.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodylabeldivadiv.NodeType);
        ...
        public void TableFormattingGoneWild()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodycenter.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodycenterfont.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfontimg.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytable.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytabletbody.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytabletbodytr.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytabletbodytrtd.NodeType);
        ...
        public void YouShouldSeeThisText()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodypa1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodypa2.NodeType);
...
This page contains an insanely badly-nested tag sequence.").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodycentercenter.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytabletbody1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytabletbodytr1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytabletbodytr2.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodytable2.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyfonta.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodya.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodyafont.NodeType);
...
nobr should have closed the div inside it implicitly. </b><pre>A pre tag outside everything else.</pre>
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodybnobr.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydiv.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydivb.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydivbnobr.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtmlbodydivpre.NodeType);
