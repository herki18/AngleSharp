namespace AngleSharp.Core.Tests.Html
{
    ...
    public class HtmlCommentTests
    {
        ...
        public void ValidCommentInRoot()
        {
            ...
            Assert.AreEqual(NodeType.Comment, (NodeType)dochtml0Comment0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0head1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0head1title0.NodeType);

            var dochtml0head1title0Text0 = dochtml0head1title0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0head1title0Text0.NodeType);
