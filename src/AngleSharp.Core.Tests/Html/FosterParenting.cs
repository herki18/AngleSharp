...
<div></div>
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1div0div1.NodeType);

            var dochtml0body1div0Text2 = dochtml0body1div0.ChildNodes[2];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1div0Text2.NodeType);
        ...
        public void FosterTableInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table3.NodeType);
        }
        ...
        public void FosterDivsInBoldFormatting()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1b0div1.NodeType);
        ...
        public void FosterParagraphAndDivInAnchor()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1div1p1.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1div1p1a0.NodeType);
        }
        ...
        public void FosterMetaInTableInTableCell()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table1tbody0tr0td0meta0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table1tbody0tr0td0table1.NodeType);

            var dochtml1body1table1tbody0tr0td0table1Text0 = dochtml1body1table1tbody0tr0td0table1.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1table1tbody0tr0td0table1Text0.NodeType);
        ...
        public void FosterStyleInTableWithSpaces()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table0style0.NodeType);

            var dochtml1body1table0style0Text0 = dochtml1body1table0style0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1table0style0Text0.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1table0Text1.NodeType);
        ...
        public void FosterScriptInTbodyInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table0tbody0script0.NodeType);

            var dochtml1body1table0tbody0script0Text0 = dochtml1body1table0tbody0script0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1table0tbody0script0Text0.NodeType);
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1table0tbody0Text1.NodeType);
        ...
        public void FosterAppletInParagraph()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1p0applet0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1p0applet0p0.NodeType);

            var dochtml1body1p0applet0p0Text0 = dochtml1body1p0applet0p0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1p0applet0p0Text0.NodeType);
...
X</listing>").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1body1listing0Text0.NodeType);
        ...
        public void FosterSelectWithMisnestedInput()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1input1.NodeType);
        ...
        public void FosterInputInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table0input0.NodeType);
        ...
        public void FosterInputAndTextInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table1input0.NodeType);
        ...
        public void FosterSpacesAndInputInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1table0input1.NodeType);
        ...
        public void ParagraphClosedWrongInDiv()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1div0p0.NodeType);

            var dochtml0body1div0p0Text0 = dochtml0body1div0p0.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1div0p0Text0.NodeType);
        ...
        public void FosterImplicitCellClosed()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody0tr0td0code0.NodeType);

            var dochtml0body1table0tbody0tr0td0Text1 = dochtml0body1table0tbody0tr0td0.ChildNodes[1];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1table0tbody0tr0td0Text1.NodeType);
        ...
        public void FosterTextInTableAfterRow()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1b3.NodeType);

            var dochtml0body1b3Text0 = dochtml0body1b3.ChildNodes[0];
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1b3Text0.NodeType);
        ...
        public void FosterSpacesTextAndFormattingAfterRow()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0body1table1tbody0Text1.NodeType);
        ...
        public void FosterKeygenInSelect()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1keygen1.NodeType);
        }
        ...
        public void StandardDoctypeProvidedAndSpaceShouldBePlacedInBodyWithSecondHeadIgnored()
        {
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml1Text1.NodeType);
        ...
        public void StandardDoctypeProvidedAndFormShouldNotCloseInDiv()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1form0div0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml1body1form0div0div0.NodeType);
        }
...
<div>").ToHtmlFragment("div");
            ...
            var docText0 = doc[0];
            Assert.AreEqual(NodeType.Text, (NodeType)docText0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docdiv1.NodeType);
        }
...
foo").ToHtmlDocument();
            ...
            Assert.AreEqual(NodeType.Text, (NodeType)dochtml0Text2.NodeType);
...
<div>").ToHtmlDocument();
        ...
        public void CellInCaptionSpawnedInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0caption0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody1tr0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0tbody1tr0td0.NodeType);
        }
        ...
        public void DivOpenedInCaptionSpawnedInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table0caption0div0.NodeType);
        }
        ...
        public void FragmentWithClosedCaptionAndOpenDivInContextOfACaption()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docdiv0.NodeType);
        }
        ...
        public void TextInColGroupSpawnedInTable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochtml0body1table1colgroup0.NodeType);
        }
        ...
        public void FragmentTextAndColInContextOfAColgroup()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doccol0.NodeType);
        }
        ...
        public void FragmentCloseFramesetAndOpenFrameInContextOfAFrameset()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docframe0.NodeType);
        }
        ...
        public void FragmentCloseRowAndOpenCellInContextOfARow()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctd0.NodeType);
        }
        ...
        public void FragmentCaptionAndOtherTableElementsInContextOfATBody()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctr0.NodeType);
        }
        ...
        public void FragmentCloseTableAndOpenRowInContextOfATable()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctbody0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)doctbody0tr0.NodeType);
        }
        ...
        public void FragmentOpenAndCloseBodyCloseHtmlInContextOfAHtml()
        {
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)dochead0.NodeType);
            ...
            Assert.AreEqual(NodeType.Element, (NodeType)docbody1.NodeType);
        }
