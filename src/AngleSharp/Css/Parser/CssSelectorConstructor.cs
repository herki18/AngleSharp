namespace AngleSharp.Css.Parser
{
    ...
    /// </summary>
    sealed class CssSelectorConstructor(CssSelectorTokenizer tokenizer, IAttributeSelectorFactory attributeSelector, IPseudoClassSelectorFactory pseudoClassSelector, IPseudoElementSelectorFactory pseudoElementSelector, Boolean invoked = false, Boolean forgiving = false)
    {
        #region Fields
        ...
        private readonly CssSelectorTokenizer _tokenizer = tokenizer;
