namespace AngleSharp.Css
{
    ...
    public class DefaultPseudoClassSelectorFactory : IPseudoClassSelectorFactory
    {
        private readonly Dictionary<String, ISelector> _selectors = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { PseudoElementNames.FirstLine, new PseudoClassSelector(el => el.HasChildNodes && el.ChildNodes[0].NodeType == (Int32)NodeType.Text, PseudoElementNames.FirstLine) },
            { PseudoElementNames.FirstLetter, new PseudoClassSelector(el => el.HasChildNodes && el.ChildNodes[0].NodeType == (Int32)NodeType.Text && el.ChildNodes[0].TextContent.Length > 0, PseudoElementNames.FirstLetter) },
        };
